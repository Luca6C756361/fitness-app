...
function Stepper({
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <span className="min-w-[2ch] text-center text-sm font-bold text-fg-primary tabular-nums">
        {value}
      </span>
      <button
        type="button"
...
export default function CompositionCart({
  ...
  return (
    <section className="rounded-2xl border border-emerald-900/5 bg-white p-6 shadow-sm">
      ...
      {/* Nome sessione */}
      <div className="mb-4">
        <label className="mb-1.5 block text-[11px] font-bold uppercase tracking-wide text-fg-secondary">
          Nome sessione
        </label>
        <input
          type="text"
          ...
          className="w-full rounded-xl border border-emerald-900/10 bg-white px-4 py-2 text-sm text-fg-primary outline-none focus:ring-2 focus:ring-emerald-300"
        />
      </div>
      ...
      {items.length > 0 && (
        <div className="mb-4 flex gap-2 rounded-xl bg-emerald-50 p-3 text-center">
          <div className="flex-1">
            <p className="text-[10px] font-bold uppercase text-fg-secondary">
              Esercizi
            </p>
            <p className="text-sm font-bold text-fg-primary tabular-nums">
              {items.length}
            </p>
          </div>
          <div className="flex-1">
            ...
            >
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-2">
                  <span className="text-[11px] font-bold uppercase tracking-wide text-fg-secondary">
                    Set
                  </span>
                  <Stepper
                    value={item.sets}
      ...
      <button
        ...
        className="mt-6 w-full rounded-xl bg-emerald-600 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-surface-raised disabled:text-fg-muted"
      >
