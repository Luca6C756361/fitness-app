        ...
        <>
            ...
            {visible.map((r) => (
              ...
              >
                <div className="flex items-baseline justify-between gap-3">
                  <p className="min-w-0 flex-1 truncate text-sm font-bold text-emerald-950">
                    {r.name}
                  </p>
                ...
                <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[11px] font-medium text-emerald-800/50 tabular-nums">
          ...
          {records.length > PREVIEW && (
            <button
              ...
              className="mt-3 w-full rounded-lg border border-emerald-900/10 py-1.5 text-xs font-bold text-emerald-800/70 transition hover:bg-emerald-50"
            >
              {expanded
                ? "Mostra meno"
